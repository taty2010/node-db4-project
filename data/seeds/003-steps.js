...
exports.seed = function(knex, Promise) {
      return knex('steps').insert([
        ...
        {id: 6, step_number: 5, instructions: 'Pour the cake mix in.', recipe_id: 1},
        {id: 7, step_number: 5, instructions: 'Put the cake tin in the middle of the oven and let it bake for 35-40 minutes.', recipe_id: 1}
      ]);
};
